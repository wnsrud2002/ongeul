...
macOS 앱 묶음과 변경 내역은 [Releases](https://github.com/wnsrud2002/ongeul/releases)에 있다. 외부 서비스 설정이나 API 키는 필요 없다. 외부 패키지는 엑셀용 `openpyxl`과 PDF 이미지·앱 아이콘용 `Pillow` 두 개다.
